...
def umfpack_di_solve(sys, Ap, Ai, Ax, X, B, Numeric, Control, Info):
    r"""umfpack_di_solve(int sys, int const [] Ap, int const [] Ai, double const [] Ax, double [] X, double const [] B, void * Numeric, double const [20] Control, double [90] Info) -> int"""
...
def umfpack_dl_solve(sys, Ap, Ai, Ax, X, B, Numeric, Control, Info):
    r"""umfpack_dl_solve(SuiteSparse_long sys, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double [] X, double const [] B, void * Numeric, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_zi_solve(sys, Ap, Ai, Ax, Az, Xx, Xz, Bx, Bz, Numeric, Control, Info):
    r"""umfpack_zi_solve(int sys, int const [] Ap, int const [] Ai, double const [] Ax, double const [] Az, double [] Xx, double [] Xz, double const [] Bx, double const [] Bz, void * Numeric, double const [20] Control, double [90] Info) -> int"""
...
def umfpack_zl_solve(sys, Ap, Ai, Ax, Az, Xx, Xz, Bx, Bz, Numeric, Control, Info):
    r"""umfpack_zl_solve(SuiteSparse_long sys, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [] Az, double [] Xx, double [] Xz, double const [] Bx, double const [] Bz, void * Numeric, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
    return __umfpack.umfpack_zl_solve(sys, Ap, Ai, Ax, Az, Xx, Xz, Bx, Bz, Numeric, Control, Info)

def umfpack_di_defaults(Control):
    r"""umfpack_di_defaults(double [20] Control)"""
    return __umfpack.umfpack_di_defaults(Control)

def umfpack_dl_defaults(Control):
    r"""umfpack_dl_defaults(double [20] Control)"""
    return __umfpack.umfpack_dl_defaults(Control)

def umfpack_zi_defaults(Control):
    r"""umfpack_zi_defaults(double [20] Control)"""
    return __umfpack.umfpack_zi_defaults(Control)

def umfpack_zl_defaults(Control):
    r"""umfpack_zl_defaults(double [20] Control)"""
    return __umfpack.umfpack_zl_defaults(Control)

def umfpack_di_triplet_to_col(n_row, n_col, nz, Ti, Tj, Tx, Ap, Ai, Ax, Map):
    r"""umfpack_di_triplet_to_col(int n_row, int n_col, int nz, int const [] Ti, int const [] Tj, double const [] Tx, int [] Ap, int [] Ai, double [] Ax, int [] Map) -> int"""
...
def umfpack_dl_triplet_to_col(n_row, n_col, nz, Ti, Tj, Tx, Ap, Ai, Ax, Map):
    r"""umfpack_dl_triplet_to_col(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long nz, SuiteSparse_long const [] Ti, SuiteSparse_long const [] Tj, double const [] Tx, SuiteSparse_long [] Ap, SuiteSparse_long [] Ai, double [] Ax, SuiteSparse_long [] Map) -> SuiteSparse_long"""
...
def umfpack_zi_triplet_to_col(n_row, n_col, nz, Ti, Tj, Tx, Tz, Ap, Ai, Ax, Az, Map):
    r"""umfpack_zi_triplet_to_col(int n_row, int n_col, int nz, int const [] Ti, int const [] Tj, double const [] Tx, double const [] Tz, int [] Ap, int [] Ai, double [] Ax, double [] Az, int [] Map) -> int"""
...
def umfpack_zl_triplet_to_col(n_row, n_col, nz, Ti, Tj, Tx, Tz, Ap, Ai, Ax, Az, Map):
    r"""umfpack_zl_triplet_to_col(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long nz, SuiteSparse_long const [] Ti, SuiteSparse_long const [] Tj, double const [] Tx, double const [] Tz, SuiteSparse_long [] Ap, SuiteSparse_long [] Ai, double [] Ax, double [] Az, SuiteSparse_long [] Map) -> SuiteSparse_long"""
...
def umfpack_di_col_to_triplet(n_col, Ap, Tj):
    r"""umfpack_di_col_to_triplet(int n_col, int const [] Ap, int [] Tj) -> int"""
    return __umfpack.umfpack_di_col_to_triplet(n_col, Ap, Tj)

def umfpack_dl_col_to_triplet(n_col, Ap, Tj):
    r"""umfpack_dl_col_to_triplet(SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long [] Tj) -> SuiteSparse_long"""
    return __umfpack.umfpack_dl_col_to_triplet(n_col, Ap, Tj)

def umfpack_zi_col_to_triplet(n_col, Ap, Tj):
    r"""umfpack_zi_col_to_triplet(int n_col, int const [] Ap, int [] Tj) -> int"""
    return __umfpack.umfpack_zi_col_to_triplet(n_col, Ap, Tj)

def umfpack_zl_col_to_triplet(n_col, Ap, Tj):
    r"""umfpack_zl_col_to_triplet(SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long [] Tj) -> SuiteSparse_long"""
    return __umfpack.umfpack_zl_col_to_triplet(n_col, Ap, Tj)

def umfpack_di_transpose(n_row, n_col, Ap, Ai, Ax, P, Q, Rp, Ri, Rx):
    r"""umfpack_di_transpose(int n_row, int n_col, int const [] Ap, int const [] Ai, double const [] Ax, int const [] P, int const [] Q, int [] Rp, int [] Ri, double [] Rx) -> int"""
...
def umfpack_dl_transpose(n_row, n_col, Ap, Ai, Ax, P, Q, Rp, Ri, Rx):
    r"""umfpack_dl_transpose(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, SuiteSparse_long const [] P, SuiteSparse_long const [] Q, SuiteSparse_long [] Rp, SuiteSparse_long [] Ri, double [] Rx) -> SuiteSparse_long"""
...
def umfpack_zi_transpose(n_row, n_col, Ap, Ai, Ax, Az, P, Q, Rp, Ri, Rx, Rz, do_conjugate):
    r"""umfpack_zi_transpose(int n_row, int n_col, int const [] Ap, int const [] Ai, double const [] Ax, double const [] Az, int const [] P, int const [] Q, int [] Rp, int [] Ri, double [] Rx, double [] Rz, int do_conjugate) -> int"""
...
def umfpack_zl_transpose(n_row, n_col, Ap, Ai, Ax, Az, P, Q, Rp, Ri, Rx, Rz, do_conjugate):
    r"""umfpack_zl_transpose(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [] Az, SuiteSparse_long const [] P, SuiteSparse_long const [] Q, SuiteSparse_long [] Rp, SuiteSparse_long [] Ri, double [] Rx, double [] Rz, SuiteSparse_long do_conjugate) -> SuiteSparse_long"""
...
def umfpack_dl_symbolic(n_row, n_col, Ap, Ai, Ax, Control, Info):
    r"""umfpack_dl_symbolic(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_zi_symbolic(n_row, n_col, Ap, Ai, Ax, Az, Control, Info):
    r"""umfpack_zi_symbolic(int n_row, int n_col, int const [] Ap, int const [] Ai, double const [] Ax, double const [] Az, double const [20] Control, double [90] Info) -> int"""
...
def umfpack_zl_symbolic(n_row, n_col, Ap, Ai, Ax, Az, Control, Info):
    r"""umfpack_zl_symbolic(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [] Az, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_di_numeric(Ap, Ai, Ax, Symbolic, Control, Info):
    r"""umfpack_di_numeric(int const [] Ap, int const [] Ai, double const [] Ax, void * Symbolic, double const [20] Control, double [90] Info) -> int"""
    return __umfpack.umfpack_di_numeric(Ap, Ai, Ax, Symbolic, Control, Info)

def umfpack_dl_numeric(Ap, Ai, Ax, Symbolic, Control, Info):
    r"""umfpack_dl_numeric(SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, void * Symbolic, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_zi_numeric(Ap, Ai, Ax, Az, Symbolic, Control, Info):
    r"""umfpack_zi_numeric(int const [] Ap, int const [] Ai, double const [] Ax, double const [] Az, void * Symbolic, double const [20] Control, double [90] Info) -> int"""
...
def umfpack_dl_get_numeric(Lp, Lj, Lx, Up, Ui, Ux, P, Q, Dx, Rs, Numeric):
    r"""umfpack_dl_get_numeric(SuiteSparse_long [] Lp, SuiteSparse_long [] Lj, double [] Lx, SuiteSparse_long [] Up, SuiteSparse_long [] Ui, double [] Ux, SuiteSparse_long [] P, SuiteSparse_long [] Q, double [] Dx, double [] Rs, void * Numeric) -> SuiteSparse_long"""
...
def umfpack_zi_get_numeric(Lp, Lj, Lx, Lz, Up, Ui, Ux, Uz, P, Q, Dx, Dz, Rs, Numeric):
    r"""umfpack_zi_get_numeric(int [] Lp, int [] Lj, double [] Lx, double [] Lz, int [] Up, int [] Ui, double [] Ux, double [] Uz, int [] P, int [] Q, double [] Dx, double [] Dz, double [] Rs, void * Numeric) -> int"""
...
def umfpack_zl_get_numeric(Lp, Lj, Lx, Lz, Up, Ui, Ux, Uz, P, Q, Dx, Dz, Rs, Numeric):
    r"""umfpack_zl_get_numeric(SuiteSparse_long [] Lp, SuiteSparse_long [] Lj, double [] Lx, double [] Lz, SuiteSparse_long [] Up, SuiteSparse_long [] Ui, double [] Ux, double [] Uz, SuiteSparse_long [] P, SuiteSparse_long [] Q, double [] Dx, double [] Dz, double [] Rs, void * Numeric) -> SuiteSparse_long"""
