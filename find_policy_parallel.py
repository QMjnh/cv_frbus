...
def gradient_descent_parallel(loss_func, policy, learning_rate=0.00001, max_iterations=1000, 
...
def gradient_descent_adam_parallel(loss_func, policy, learning_rate=0.001, max_iterations=1000, 
                          tolerance=1e-6, verbose=False, epochs='auto', patience=50, 
...
def main():
    ...
    parallel_result, parallel_time = time_function(gradient_descent_parallel, dummy_loss, policy.copy(), verbose=False)
    print("\n")

    # parallel_result, parallel_time = time_function(gradient_descent_adam_parallel, dummy_loss, policy.copy(), verbose=False)
    # print("\n")
