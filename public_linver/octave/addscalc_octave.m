...
fshkcoef = 1;
ind_nonelb_adds = 0;
if strcmp(ecfs_option,"yes") | strcmp(mprule,"adur") | strcmp(mprule,"aait")
    ind_nonelb_adds = 1;
end
...
while vflag == 1
    ...
    if strcmp(mprule,"aait") & madiff_asymterm > asym_epsi
    ...
    if strcmp(mprule,"adur") & madiff_asymterm > asym_epsi
    ...
    if strcmp(threshold_forces,"yes")
        forceqtrs(1:lfqtr) = 1;
    end
