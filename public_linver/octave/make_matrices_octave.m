...
track_locs = [1:ntrack];
for i = 1:ntrack
    track_locs(i) = inv_order_var(find(strcmp(endo_names,track_names(i))));
end
...
if strcmp(ecfs_option,"yes")
    fiscal_shk_loc = find(strcmp(exog_names,"fiscal_aerr"));
end
...
rff_loc = inv_order_var(find(strcmp(endo_names,"rff")));
xgap2_loc = inv_order_var(find(strcmp(endo_names,"xgap2")));
if strcmp(mprule,"adur")
    dlur2_loc = inv_order_var(find(strcmp(endo_names,"dlur2")));
end
if strcmp(mprule,"adur") | strcmp(uthresh_imposed,"yes")
    ucond_loc = inv_order_var(find(strcmp(endo_names,"ucond")));
end
if strcmp(mprule,"aait")
    pic32_loc = inv_order_var(find(strcmp(endo_names,"pic32")));
    picx4_loc = inv_order_var(find(strcmp(endo_names,"picx4")));
end
if strcmp(pithresh_imposed,"yes")
    picond_loc = inv_order_var(find(strcmp(endo_names,"picond")));
end
...
for i = 1:predqtrs-1
    a(1,i+1) = ['eradd',num2str(i)];
end
eradd_locs = [1:predqtrs];
for i = 1:predqtrs;
    eradd_locs(i) = inv_order_var(find(strcmp(endo_names,a(i))));
end
...
rff_eradd_names = {'e0'};
if exist('OCTAVE_VERSION')
    rff_eradd_names = cellstr(rff_eradd_names);
else
    rff_eradd_names = string(rff_eradd_names);
end
for i = 1:predqtrs
    rff_eradd_names(1,i+1) = ['e',num2str(i)];
end
rff_eradd_locs = [1:predqtrs];
xlocs = [1:nxv];
for i = 1:predqtrs;
    rff_eradd_locs(i) = xlocs(find(strcmp(exog_names,rff_eradd_names(i)))); 
end
