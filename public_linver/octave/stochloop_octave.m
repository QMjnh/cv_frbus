...
for ireplic = 1:nreplic
    ...
    for iqtr = 1:nsimqtrs
        ...
        if strcmp(elb_imposed,"yes") | strcmp(mprule,"adur") | ...
	        strcmp(mprule,"aait")
            yl(eradd_locs,1) = 0;
        end
        ...
        if strcmp(uthresh_imposed,"yes") == 0 & strcmp(pithresh_imposed,"yes") == 0
        ...
        % are needed (cases 1 and 2), call addscalc_thresh_octave. If
