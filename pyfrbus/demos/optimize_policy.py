...
custom_stayhome.to_csv("./results/external_const/custom_stayhome.csv", index=True)
...
custom_plot(dfs, '2020Q1', '2023Q4', plots, variables, './results/external_const/labor quality.png', plot_title='No April lockdown + same foreign variables')
...
custom_plot(dfs, '2020Q1', '2023Q4', plots, variables, './results/external_const/(un)employment.png', plot_title='No April lockdown + same foreign variables')
...
custom_plot(dfs, '2020Q1', '2023Q4', plots, variables, './results/external_const/export+import.png', plot_title='No April lockdown + same foreign variables')
